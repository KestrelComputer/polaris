...
.PHONY: test test_xprs test_alu test_immpicker test_instruction_decoder test_stage_f

test: test_xprs test_alu test_immpicker test_instruction_decoder test_stage_f
